...
RUN apt update && apt -y --no-install-recommends install ruby=1:2.3.3 ruby-dev=1:2.3.3 build-essential devscripts \
    debhelper fakeroot lintian lsb-release zlib1g-dev libpq-dev postgresql-client git-changelog python-setuptools curl
